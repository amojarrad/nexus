...
function nexus_form_system_theme_settings_alter(&$form, \Drupal\Core\Form\FormStateInterface $form_state) {
  ...
  $form['nexus_settings']['slideshow']['slide5']['slide5_image'] = array(
      '#type' => 'managed_file',
      '#title' => t('Image 5'),
      '#default_value' => theme_get_setting('slide5_image','nexus'),
      '#upload_location' => 'public://',
  );
  ...
  $form['nexus_settings']['slideshow']['slide6']['slide6_image'] = array(
      '#type' => 'managed_file',
      '#title' => t('Image 6'),
      '#default_value' => theme_get_setting('slide6_image','nexus'),
      '#upload_location' => 'public://',
  );
  ...
  $form['nexus_settings']['slideshow']['slide7']['slide7_image'] = array(
      '#type' => 'managed_file',
      '#title' => t('Image 7'),
      '#default_value' => theme_get_setting('slide7_image','nexus'),
      '#upload_location' => 'public://',
  );
  ...
  $form['nexus_settings']['slideshow']['slide8']['slide8_image'] = array(
      '#type' => 'managed_file',
      '#title' => t('Image 8'),
      '#default_value' => theme_get_setting('slide8_image','nexus'),
      '#upload_location' => 'public://',
  );
  ...
  $form['nexus_settings']['slideshow']['slide9']['slide9_image'] = array(
      '#type' => 'managed_file',
      '#title' => t('Image 9'),
      '#default_value' => theme_get_setting('slide9_image','nexus'),
      '#upload_location' => 'public://',
  );
  ...
  $form['nexus_settings']['slideshow']['slide10']['slide10_image'] = array(
      '#type' => 'managed_file',
      '#title' => t('Image 10'),
      '#default_value' => theme_get_setting('slide10_image','nexus'),
      '#upload_location' => 'public://',
  );
